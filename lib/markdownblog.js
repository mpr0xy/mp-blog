...
markdownblog = {
  ...
  'data' :    {'articles': {}, 'pages': {}, 'category': {}, 'tags': {}}, 
...
exports.processArticles = function (){
  for (a = this.files.articles.length; a--;){
    ...
    console.dir(this.data.category)
...
exports.getWidget = function() {
  var widget = {}
  widget.categories = this.getCategories()
  widget.tags = this.getTags()
  return widget
}
...
exports.getArticles = function (isExcerpt){
  ...
  for (var filename in this.data.articles){
    var article = _.assign({}, this.data.articles[filename])
    if (isExcerpt){
      article.html = ''
      article.content = ''
